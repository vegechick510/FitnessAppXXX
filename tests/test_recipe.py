...
class TestApplication_2(unittest.TestCase):
    ...
    def test_fitness_recipes_content_5(self):
        ...
        assert (
            b"A high-protein, low-carb salad with greens, grilled chicken"
            in response.data
        )
    ...
    def test_fitness_recipes_content_6(self):
        ...
        assert (
            b"A delicious smoothie bowl with protein powder, fresh fruits"
            in response.data
        )
    ...
    def test_fitness_recipes_content_7(self):
        ...
        assert (
            b"A healthy stir-fry with quinoa, broccoli, bell peppers" in response.data
        )
