[**FitnessApp on GitHub**](https://github.com/VibhavDeo/FitnessApp) | 87
---|---
**Item** | **Assessment** | **Evidence**
Video | 3 |
Workload is spread over the whole team (one team member is often X times more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot) | 3 | [Commits on GitHub](https://github.com/VibhavDeo/FitnessApp/commits/master)
Number of commits | 3 |
Number of commits by different people | 3 | [Commits on GitHub](https://github.com/VibhavDeo/FitnessApp/commits/master)
...
Docs: documentation generated format not ugly | 3 | [Readme documentation](https://github.com/VibhavDeo/FitnessApp/README.md)
...
Docs: why: docs tell a story | 3 | Can be seen in the video, and the readme is catchy
Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code. | 3 | Video and readme exist and are catchy
Use of version control tools | 3 | GitHub used
Use of style checkers | 3 | [Style checker](https://github.com/VibhavDeo/FitnessApp/blob/main/.github/workflows/style_checker.yml)
Use of code formatters | 3 | [Code formatter](https://github.com/VibhavDeo/FitnessApp/blob/main/.github/workflows/code_formatter.yml)
Use of syntax checkers | 3 | [Syntax checker](https://github.com/VibhavDeo/FitnessApp/blob/main/.github/workflows/syntax_checker.yml)
Use of code coverage | 3 | [Code coverage](https://github.com/VibhavDeo/FitnessApp/blob/main/.github/workflows/code_cov.yml)
Other automated analysis tools | 3 | [GitHub Actions](https://github.com/VibhavDeo/FitnessApp/actions)
Test cases exist | 3 | [Test cases](https://github.com/VibhavDeo/FitnessApp/blob/main/tests/test_module.py)
Test cases are routinely executed | 3 | [Seen in GitHub workflows](https://github.com/VibhavDeo/FitnessApp/actions)
The files CONTRIBUTING.md list coding standards and lots of tips on how to extend the system without screwing things up | 3 | [CONTRIBUTING.md](https://github.com/VibhavDeo/FitnessApp/blob/master/CONTRIBUTING.md)
...
Short release cycles | 3 | [Releases on GitHub](https://github.com/VibhavDeo/FitnessApp/releases)
...
Is the name of your project/software unique? | Y | FitnessApp is unique
...
If you provide more extensive documentation, does this provide clear step-by-step instructions on how to deploy and use your software? | Y | [README documentation](https://github.com/VibhavDeo/FitnessApp/blob/master/README.md)
...
Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation? | Y | [GitHub Tags](https://github.com/VibhavDeo/FitnessApp/tags)
...
Does your project have a ticketing system to manage bug reports and feature requests? | Y | [Issues on GitHub](https://github.com/VibhavDeo/FitnessApp/issues)
Is your project's ticketing system publicly visible to your users so they can view bug reports and feature requests? | Y | Bugs and issues are discussed among the team members
...
Does your documentation list all third-party dependencies? | Y | [Requirements](https://github.com/VibhavDeo/FitnessApp/blob/master/requirements.txt)
Does your documentation list the version number for all third-party dependencies? | Y | [Requirements](https://github.com/VibhavDeo/FitnessApp/blob/master/requirements.txt)
Does your software list the web address and licenses for all third-party dependencies and say whether the dependencies are mandatory or optional? | N/A |
...
Do you have a framework to periodically (e.g. nightly) run your tests on the latest version of the source code? | Y | [GitHub Actions](https://github.com/VibhavDeo/FitnessApp/actions)
Do you use continuous integration, automatically running tests whenever changes are made to your source code? | Y | [GitHub Actions](https://github.com/VibhavDeo/FitnessApp/actions)
Are your test results publicly visible | Y | [GitHub Actions](https://github.com/VibhavDeo/FitnessApp/actions)
...
Does your website state how many projects and users are associated with your project? | Y | [GitHub Stats](https://github.com/VibhavDeo/FitnessApp)
Do you provide success stories on your website? | N |
Do you list your important partners and collaborators on your website? | Y | [GitHub Stats](https://github.com/VibhavDeo/FitnessApp)
...
Can users subscribe to notifications of changes to your source code repository? | Y |
...
Is your software released under an open source license? | Y | MIT
Is your software released under an OSI-approved open-source license? | Y | [Open Source Licenses](https://opensource.org/licenses/)
