...
|Issues reports: there are **many** Issues are being closed|3|evidence in(https://github.com/token1029/FitnessApp/pulse)|
|DOI badge: exists|3|evidence in(https://github.com/token1029/FitnessApp)|
|Docs: doco generated, format not ugly|3|evidence in(https://github.com/token1029/FitnessApp)|
...
|Use of syntax checkers. |3|evidence in(https://github.com/token1029/FitnessApp/blob/main/.github/workflows/syntax_checker.yml)|
|Use of code coverage |3|evidence in(https://github.com/token1029/FitnessApp/blob/main/.github/workflows/code_cov.yml)|
|Other automated analysis tools|3|evidence in(https://github.com/token1029/FitnessApp/blob/main)|
|Test cases exist|3|sufficient test cases exsit (https://github.com/token1029/FitnessApp/tree/main/tests)|
|Test cases are routinely executed|3|evidence (https://github.com/token1029/FitnessApp/tree/main/README.md)|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up|3|evidence in (https://github.com/token1029/FitnessApp/blob/main/CONTRIBUTING.md)
|Issues are discussed before they are closed|3|(https://github.com/token1029/FitnessAPP/issues)|
|Chat channel: exists|3|chat group exists [Link](https://discord.com/invite/x7NhfFdK)|
|Test cases: a large proportion of the issues related to handling failing cases.|3|evidence in(https://github.com/token1029/FitnessApp/tree/main/tests)|
