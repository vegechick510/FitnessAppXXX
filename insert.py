...
default_order = ["upcoming-meetings", "workout-streak", "gallery", "must-try", "most-popular", "meditation", "carousel-1", "introduction-video", 'workout-reminder', 'progress-bar', 'fitness-recipes']
